...
function initTranslations(config) {
    ...
    var useLocale = function () { return (0, react_1.useContext)(localeContext); };
    function makeTranslations(translations) {
        return function () {
            var state = (0, react_1.useState)(translations)[0];
    ...
    var TranslationsProvider = function (_a) {
        ...
        var _b = (0, react_1.useState)(selectedLang), locale = _b[0], _setLocale = _b[1];
